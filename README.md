...
- 과정 13 (동의 항목)
  ![Image](https://github.com/user-attachments/assets/b52ea01e-cb50-4349-a9ca-7de800db4fc7)
- 과정 14 (추가 동의를 위한 권한 신청)
  ![Image](https://github.com/user-attachments/assets/7756bca7-d3ad-4631-8372-cf1e89af4834)
- 과정 15
...
## 인가 키 생성 후 AccessToken 요청하기

- 인가 키를 이용해서 `AccessToken`을 발급받고,
...
- `/src/pages/member/After.jsx` 기능 추가(AccessToken 발급 및 상속)
